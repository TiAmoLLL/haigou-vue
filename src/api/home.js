 ...
 * @Author: lzy
 * @Description: test
 * @Date: 2022-08-03 17:06:12
 * @LastEditTime: 2022-08-11 16:24:28
 * @FilePath: \haigou-vue-app\src\api\home.js
 */
...
return axios.get('/api/pro/seckilllist',{params})
}
/**
 * 首页分页列表的封装
...
export function getProList(params){
    return axios.get('/api/pro/list', { params })
}